...
import javax.swing.border.EtchedBorder;
	...
	class GUI{
	    public static void doGUI(){
	    	...
	    	Repository r= new Repository("src/ObjectsFiles/Obiecte.txt");
	    	Service s= new Service(r);
	    	Console c= new Console(s);
			JFrame frame = new JFrame("Inventar Magazie");																	//creem un nou frame(fereastra)
			
			ImageIcon image = new ImageIcon("src/images/icon1.png");							//se initializeaza si declareaza icons care vor fi folosite in fereastra
			ImageIcon icon = new ImageIcon("src/images/icon2.png");
			ImageIcon icon2 = new ImageIcon("src/images/icon3.png");
			ImageIcon icons = new ImageIcon("src/images/icon4.png");
